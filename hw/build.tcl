...
# Set 'sources_1' fileset properties for local files
set obj [get_filesets sources_1]
...
file copy $origin_dir/src/mig/mig-xc7a100t.prj ${proj_name}/${proj_name}.srcs/sources_1/ip/mig_7series_0/mig.prj
