...
*/
wire fully_en = (addr_i[31:20] == 12'hC41) && en_i;
wire pooling_en = (addr_i[31:20] == 12'hC42) && en_i;
wire conv_top_en = (addr_i[31:20] == 12'hC43) && en_i;

assign ready_o = S == S_CONV ? conv_ready : 
                S == S_POOLING ? pooling_ready: fully_ready;
                
assign data_o = S == S_POOLING ?  pooling_data : fully_data;
reg [2:0] S, S_next;
localparam S_CONV = 1, S_SEND = 2, S_POOLING = 3, S_FULLY = 4;
...
begin
    ...
    case(S)
        S_CONV: begin
            ...
            else if(fully_en) S_next=S_FULLY;
        end
        S_POOLING: begin
